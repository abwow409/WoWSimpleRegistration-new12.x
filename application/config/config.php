...
0 = Classic  (1.x)
1 = The Burning Crusade (TBC) (2.x)
2 = Wrath of the Lich King (WotLK) (3.x)
3 = Cataclysm  (4.x)
4 = Mist of Pandaria (MOP) (5.x)
5 = Warlords of Draenor (WOD)  (6.x)
6 = Legion (7.x)
7 = Battle for Azeroth  (8.x)
8 = Shadowlands  (9.x)
9 = Dragonflight  (10.x)
10 =The War Within  (11.x)
11 = Midnight   (12.x)
*/
$config['expansion'] = '11'; // '2' corresponds to "Wrath of the Lich King" (WotLK).
...
$config['disable_online_players'] = true; // Set to true to hide the online players page.
$config['disable_changepassword'] = true; // Set to true to disable password changes.

// Multiple Email Account Creation - Configure whether to allow multiple accounts to be created with the same email address.
$config['multiple_email_use'] = true; // Change to true to allow creation of multiple accounts with the same email.

// Template Selection - Choose which template to use for the appearance of your website.
$config['template'] = 'light'; // Available templates: light, advance, icecrown, kaelthas, battleforazeroth, legion, legion-advance,12.1

// SMTP Configuration - Required for sending out emails (e.g., password recovery).
$config['smtp_host'] = 'smtp.gmail.com'; // SMTP host address.
$config['smtp_port'] = 587; // SMTP port.
$config['smtp_auth'] = true; // Toggle SMTP authentication.
$config['smtp_user'] = 'youremail@gmail.com'; // SMTP username.
$config['smtp_pass'] = 'abcd efgh ijkl mnop'; // SMTP password.
$config['smtp_secure'] = 'tls'; // Encryption method: 'tls' or 'ssl'.
$config['smtp_mail'] = 'youremail@gmail.com'; // The email address emails are sent from.
...
// Captcha Configuration - Choose the type of captcha to use for security purposes.Suggest using image verification code= 0 or ReCaptcha verification code=2
$config['captcha_type'] = 2; // Options: 0 (Image Captcha), 1 (HCaptcha), 2 (ReCaptcha v2), 3 (Cloudflare Turnstile), or >3 (Disable captcha).
$config['captcha_key'] = '6LeIxAcTAAAAAJcZVRqyHh71UMIEGNQ_MXjiZKhI'; // The site key for HCaptcha, Recaptcha, or Cloudflare Turnstile. Leave empty for image captcha.
$config['captcha_secret'] = '6LeIxAcTAAAAAGG-vFI1TnRWxMZNFuojJ4WifJWe'; // The secret key for HCaptcha, Recaptcha, or Cloudflare Turnstile. Leave empty for image captcha.
...
$config['soap_for_register'] = true; // Enable this only if you are certain of your SOAP configuration.
$config['soap_host'] = '127.0.0.1'; // The SOAP service address.
$config['soap_port'] = '7878'; // The SOAP service port.
$config['soap_uri'] = 'urn:TC'; // The SOAP URI, change as per your core's SOAP implementation.
$config['soap_style'] = 'SOAP_RPC'; // The SOAP style.
$config['soap_username'] = '1#1'; // The username for SOAP authentication. This must be the "account-username" field in the "auth" table of the database
$config['soap_password'] = 'password'; // The password for SOAP authentication.
$config['soap_ca_command'] = 'bnetaccount create {$email} {$password}'; // The SOAP command for creating an account.
...
$config['db_auth_user'] = 'trinity'; // Database username.
$config['db_auth_pass'] = 'trinity'; // Database password.
